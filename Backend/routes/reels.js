...
// Share routes
router.post('/:id/share', authMiddleware, reelService.shareReel);
router.put('/:id/share', authMiddleware, reelService.updateReelShare);
router.get('/:id/share/check', authMiddleware, reelService.checkReelShared);
